...
<div class="row">
    <div class="col-lg-8 pl-lg-0">
        <div class="card card-details">
           ...
           <img 
           src="{{Storage::url($item->galleries->first()->images)}}" 
           class="xzoom" 
           id="xzoom-default" 
...
<div class="col-md-4 border-left">
    ...
    <img src="{{url('frontend/images/a.png')}}" alt="" class="features-images">
...
<div class="col-md-4 border-left">
    <img src="{{url('frontend/images/b.png')}}" alt="" class="features-images">
    <div class="description">
        <h3>
            Languange
        </h3>
...
<div class="col-md-4 border-left">
    <img src="{{url('frontend/images/c.png')}}" alt="" class="features-images">
    <div class="description">
        <h3>
            Foods
        </h3>
...
<div class="join-container">
    ...
    <form method="POST" action="{{route('checkout_process',$item->id)}}">
    @csrf
