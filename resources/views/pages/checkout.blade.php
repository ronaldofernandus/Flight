...
@forelse($item->details as $detail)
    ...
    <img src="{{url('/frontend/images/icon x.png')}}" alt="">
    </a>
    </td>
    </tr>
    @empty
...
<div class="member mt-3">
    ...
    @csrf
        ...
        <label for="doe_password" class="sr-only">DOE Passport</label>
...
Add Now 
    ...
    <div class="col-lg-4">
        <div class="card card-details card-right">
            ...
            <p class="payment-instructions">Please complete payment</p>
               <div class="bank">
                   <div class="bank-item pb-3">
                       <img src="{{url('/frontend/images/BCA.png')}}" class="bank-images">
                   ...
                   <div class="bank-item pb-3">
                    <img src="{{url('/frontend/images/Mandiri.png')}}" class="bank-images">
                    <div class="description">
                        <h3>PT.FLIGHT ID</h3>
                        <p>0123456789
                            <br>
