...
<body style="word-spacing:normal;background-color:#E4E6EB;">
  <div style="background-color:#E4E6EB;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:150px;">
                                <img height="auto" src="{{url('frontend/images/flight.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071c4d;">Here's Your E-Tickets</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img height="auto" src="{{ url('storage/'.$data->travel_package->galleries[0]->images) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica,Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c4d;">Hi,{{$data->user->name}}<br><br> Tiket digital kamu berhasil di cetak <br> Booking Id <strong>#{{$data->id}}</strong></div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica,Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    <td><strong> Derpature</strong></td>
                                    <td style="text-align:right;">{{$data->travel_package->title}}</td>
                                  </tr>
                                  <tr>
                                    <td><strong> Date an Time</strong></td>
    ...
    padding-left:10px;
    color:#071c4d;
    font-family:Assistant, Helvetica,Arial, sans-serif;"> Butuh Bantuan? </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
    ...
    <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table  cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;background-color:#ffffff;width:100%;">
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:20px;padding-top:0px;text-align:center;">
              <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table  cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td  style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width:50px;">
                              <image src="{{url('frontend/images/email@2x.png')}}" width="40px">
                            </td>
                            <td style="font-size:18px; 
    padding-left:0px;
    color:#071c4d;
    font-family:Assistant, Helvetica,Arial, sans-serif;"> supportflight.com </td>
                          </tr>
                          <tr>
                            <td style="width:50px;">
                              <image src="{{url('frontend/images/phone@2x.png')}}" width="40px">
                            </td>
                            <td style="font-size:18px; 
    padding-left:0px;
    color:#071c4d;
    font-family:Assistant, Helvetica,Arial, sans-serif;"> 085156287441 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica,Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">2019 Copyright Flight.All Right Reserved.Made in Jakarta</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
